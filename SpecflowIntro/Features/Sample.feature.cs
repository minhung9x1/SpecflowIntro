...
#line hidden
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("Create a new employee with mandatary details multi test case")]
        [NUnit.Framework.TestCaseAttribute("Hung1", "11", "0123", "lai.minh.hung@kloon.vn", null)]
        [NUnit.Framework.TestCaseAttribute("Hung2", "22", "0912", "hung123@kloon.vn", null)]
        [NUnit.Framework.TestCaseAttribute("Hung3", "33", "0912", "hung123@kloon.vn", null)]
        [NUnit.Framework.TestCaseAttribute("Hung4", "44", "0912", "hung123@kloon.vn", null)]
        public virtual void CreateANewEmployeeWithMandataryDetailsMultiTestCase(string name, string age, string phone, string email, string[] exampleTags)
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Create a new employee with mandatary details multi test case", exampleTags);
#line 25
this.ScenarioSetup(scenarioInfo);
#line 28
testRunner.When(string.Format("I fill all the mandatory details in form with {0} and {1}", name, age), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
            this.ScenarioCleanup();
        }
